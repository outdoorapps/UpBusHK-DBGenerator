...
data class Datum(
    ...
    @Json(name = "description_tc") val descriptionTc: String,
    @Json(name = "description_sc") val descriptionSc: String,
...
data class Headway(
    ...
    @Json(name = "public_holiday") val publicHoliday: Boolean,
    @Json(name = "headway_seq") val headwaySeq: Int,
    @Json(name = "start_time") val startTime: String,
    @Json(name = "end_time") val endTime: String,
    val frequency: Int? = null,
    @Json(name = "frequency_upper") val frequencyUpper: Any? = null
)
